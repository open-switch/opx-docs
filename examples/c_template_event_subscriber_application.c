...
Sample of how to compose a CPS API GET request object,   
...
This template illustrates the initialization of the event service 
and event processing thread, registration of the event handler 
function and event processing callback. The key list specified 
in the registration is used to determine the events that are 
delivered to this application (in this case, the list contains 
a single element).
******************************************************************/
